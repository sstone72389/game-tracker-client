...
/***/ (function(module, exports, __webpack_require__) {
	...
	var blogEvents = __webpack_require__(35
...
/***/ (function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    production: 'https://tranquil-coast-56887.herokuapp.com',
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var blogAPI = __webpack_require__(13);
	var blogUI = __webpack_require__(14
	...
	var onSignIn = function onSignIn(event) {
	  ...
	  api.signIn(data).then(ui.signInSuccess).then(function () {
	    blogAPI.showPosts().then(blogUI.showPostSuccess).catch(blogUI.showPostFailure);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var showPosts = function showPosts(data) {
	  return $.ajax({
	    url: config.apiOrigin + '/posts/',
	    method: 'GET',
	    headers: {
	...
	var removeById = function removeById(data) {
	  return $.ajax({
	...
	var updateById = function updateById(data, findId) {
	  event.preventDefault();
	  return $.ajax({
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var addPostSuccess = function addPostSuccess(response) {
	  $('input').val('');
	  $('.clear-field').val('');
	};

	var addPostFailure = function addPostFailure() {
	  $('input').val('');
	  $('#succ-fail-mess').text('Failure Adding Post').fadeIn().delay(2000).fadeOut('slow');
	};

	var showPostSuccess = function showPostSuccess(response) {
	  store.postResponse = response;
	  var showPostsHtml = showPostsTemplate({ posts: response.posts });
	  $('.post-display').html(showPostsHtml);
	};

	var showPostFailure = function showPostFailure() {
	...
	var removePostFailure = function removePostFailure(response) {
	  $('input').val('');
	...
	var updatePostFailure = function updatePostFailure(response) {
	...
	module.exports = {
	  ...
	  addPostFailure: addPostFailure,
	  showPostFailure: showPostFailure,
	  ...
	  removePostFailure: removePostFailure
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n    <ul class=\"post-list col-md-12\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n      <div class=\"post-name\">\n        <li>\n\n            <div class=\"youtube\" ytid=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
	    + "\" onclick=\"ytload(this)\">\n              <img class=\"ply-btn\" src=\"http://res.cloudinary.com/dfu4pwocw/image/upload/v1498168581/youtube-play-icon-overlay_bihuso.png\"></img>\n              <img class=\"resp-img\" src=\"https://img.youtube.com/vi/"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
	    + "/maxresdefault.jpg\" style=\"width: 560px; height: 315px;\"></img>\n            </div>\n\n          <div class=\"list-title\">\n            <span class=\"span-title\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.title : stack1), depth0))
	    + "</span>\n            <button class=\"remove-post-button btn btn-transparent\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">Delete</button>\n            <button class=\"edit-post-button btn btn-transparent\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	  ...
	  return "<div class=\"text-center\">\n  <span class=\"span-title\">"
	    + container.escapeExpression(container.lambda(((stack1 = (depth0 != null ? depth0.post : depth0)) != null ? stack1.title : stack1), depth0))
	    + "</span>\n\n"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onShowPosts = function onShowPosts(event) {
	  event.preventDefault();
	  api.showPosts().then(ui.showPostSuccess).catch(ui.showPostFailure);
	};

	// chains showPost to allow posts to be always visible
	var onAddPost = function onAddPost(event) {
	  event.preventDefault();
	  var data = getFormFields(this
	  // uses regexp to check that url is a valid youtube url and pulls the needed id.
	  );var videoid = data.post.name.match(/(?:https?:\/{2})?(?:w{3}\.)?youtu(?:be)?\.(?:com|be)(?:\/watch\?v=|\/)([^\s&]+)/
	  ...
	  // if (data.post.name.includes('embed') && videoid != null) {
	    ...
	    api.addPost(data).then(ui.addPostSuccess).then(function () {
	      api.showPosts(data).then(ui.showPostSuccess).catch(ui.showPostFailure);
	...
	var onShowModal = function onShowModal(event) {
	  ...
	  var findTitle = $(event.target).closest('.post-list').find('.post-name span').text();
	  var findContent = $(event.target).closest('.post-list').find('.post-content li').text();
	...
	var onUpdatePost = function onUpdatePost(event) {
	  ...
	  if (data.post.content.length >= 1 && data.post.title.length >= 1) {
	    api.updateById(data, store.currentId).then(ui.updatePostSuccess).then(function () {
	      api.showPosts(data).then(ui.showPostSuccess).catch(ui.showPostFailure);
	...
	var onRemovePost = function onRemovePost(event) {
	  var findId = $(event.target).attr('data-id');
	  api.removeById(findId).then(ui.removePostSuccess).then(function () {
	    api.showPosts().then(ui.showPostSuccess).catch(ui.showPostFailure);
